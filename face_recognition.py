...
class Face_Recognition:
    def __init__(self,root):
        ...
        img_bottom=img_bottom.resize((550,650),Image.ANTIALIAS)
        ...
        img_b=img_b.resize((730,650),Image.ANTIALIAS)
        ...
        b1_1=Button(f_lbl,text="Face Recognition",command=self.face_recog, cursor="hand2",font=("times new roman",16,"bold"),bg="green",fg="white")
        b1_1.place(x=275,y=570,width=174,height=40)

        b1_1=Button(f_lb,text="Emotion Detector", cursor="hand2",font=("times new roman",16,"bold"),bg="green",fg="white")
        b1_1.place(x=200,y=170,width=174,height=40)
