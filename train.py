...
class Train:
    def __init__(self,root):
        ...
        img_top=Image.open(r"college_images\facetrain.webp")
        img_top=img_top.resize((1280,270),Image.ANTIALIAS)
        self.photoimg_top=ImageTk.PhotoImage(img_top)

        f_lbl=Label(self.root,image=self.photoimg_top)
        f_lbl.place(x=0,y=50,width=1280,height=270)
        ...
        b1_1.place(x=0,y=320,width=1280,height=60)


        img_bottom=Image.open(r"college_images\facetrain1.webp")
        img_bottom=img_bottom.resize((1280,300),Image.ANTIALIAS)
        self.photoimg_bottom=ImageTk.PhotoImage(img_bottom)

        f_lbl=Label(self.root,image=self.photoimg_bottom)
        f_lbl.place(x=0,y=380,width=1280,height=300)
